        ...
        <article>
            <?php
                echo '
                    ...
                    <h5>Author: '. $blogPosts[$i]['author'] .'</h5>
                    <h6>Published On: '. $blogPosts[$i]['publish'] .'</h6>
                    <p style="padding: 15px; line-height:2;">'. $blogPosts[$i]['body'] .'</p>
                ';
            ?>
        </article>
